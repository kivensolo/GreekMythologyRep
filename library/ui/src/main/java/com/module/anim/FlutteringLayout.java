...
public class FlutteringLayout extends RelativeLayout {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        mEnterDuration = a.getInt(R.styleable.FlutteringLayout_heart_enter_duration,mEnterDuration);
        mDuration = a.getInt(R.styleable.FlutteringLayout_heart_duration,mDuration);
        mScale = a.getFloat(R.styleable.FlutteringLayout_heart_scale,mScale);
        mIsSameSize = a.getBoolean(R.styleable.FlutteringLayout_heart_same_size,mIsSameSize);
