...
/**
 * 除了Window的flags是FLAG_NOT_TOUCH_MODAL，可以触摸
 * 其他的和FloatPhone一样。
 */
class PopupFloatPhone extends FloatView {
    ...
    PopupFloatPhone(Context applicationContext, PermissionListener permissionListener) {
