...
public class FloatWindow {
    ...
    public static class B {
        ...
        int yOffset;
        int magnetMargin;
        boolean keepInScreenRange = false;
        boolean mShow = true;
        Class[] mActivities;
        int mMoveType = MoveType.slide_force;
        ...
        public B setView(@NonNull View view, Boolean popup) {
            mView = view;
            if(popup){
                isPopup = true;
            }
        ...
        /**
         * 设置悬浮Window不管怎么拖动，都在屏幕可视区域类
         * @param keep 是否控制在屏幕区域类
         */
        public B setInScreenRange(boolean keep){
            keepInScreenRange = keep;
            return this;
        }

        /**
         * 设置磁吸效果间距 默认为0
         * @param magnetMargin 在{@link MoveType#slide_magnet} 模式下,View距离边界多远距离时,就将其吸附至边缘
         */
        public B setMagnetSpace(int magnetMargin){
            this.magnetMargin = magnetMargin;
            return this;
        }
        ...
        /**
         * 设置悬浮球移动类型
         * @param moveType  MoveType.MOVE_TYPE
         */
        ...
        /**
         * 设置带边距的贴边动画，只有 moveType 为{@link MoveType#slide_force}设置边距才有意义，这个方法不标准，后面调整
         *
        ...
        /**
         * 设置动画效果，只在以下模式下设置此项才有意义：
         * - {@link MoveType#slide_force}
         * - {@link MoveType#slide_magnet}
         * - {@link MoveType#back}
         *
         * 默认减速插值器，默认动画时长为 300ms。
         * @param duration 动画时长
         * @param interpolator 减速插值器
         */
