 ...
 */
package com.kingz.library.ffmpeg;
...
/* package */ final class FfmpegDecoder extends
  ...
  /**
   * Returns the channel count of output audio. May only be called after .
   */
  ...
  /**
   * Returns the sample rate of output audio. May only be called after .
   */
